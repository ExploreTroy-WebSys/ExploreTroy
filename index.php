  ...
  <section class="explore-banner">
    ...
    <div class="container columns">
      <div class="row explore-boxes justify-content-center">
        <div class="shadow col-md-3 col-sm-12 explore-box-1 explore-box">
          <i class="fas fa-utensils fa-5x explore-icon"></i>          
        </div>
        <div class="shadow col-md-3 col-sm-12 explore-box-2 explore-box">
          <i class="fas fa-store fa-5x explore-icon"></i>
        </div>
        <div class="shadow col-md-3 col-sm-12 explore-box-3 explore-box">
